...
import { desc, object, p } from 'motion/react-client'
...
function HomeClient({ email }: { email: string }) {
    ...
    const features = [
        {
            title: "Plug and Play",
            desc: "Add to chatbot to your site with a single script tag."
        },
        {
    ...
    const handleLogOut = async () => {
        try {
            const rejult = await axios.get("/api/auth/logout")
    ...
    overflow-x-hidden'>
            ...
            border-b border-zinc-200'>
                <div className='max-w-7xl mx-auto px-16 h-16 flex items-center justify-between'>
                    ...
                    {email ? <div className='relative' ref={popupRef}>
                        ...
                        <button className='w-10 h-10 rounded-full bg-black text-white flex 
                    ...
                    </div> : <button className='px-5 py-2 rounded-full bg-black text-white text-sm 
                    font-medium hover:bg-zinc-800 transition disabled:opacity-60 flex 
                    items-center gap-2'
            ...
            <section className='pt-36 pb-28 px-6'>
                <div className='max-w-6xl mx-auto grid grid-cols-1  md:gird-cols-2 gap-20 items-center'>
                    <motion.div
                    ...
                    >
                        ...
                        <p className='mt-6 text-lg text-zinc-600 max-w-xl'>
                            Add a powerfull AI Chatbot to your websites in minits.<br />
                            Let your customers get instant answers using your own business knowledge.
                        </p>

                        <div className='mt-10 flex gap-4'>

                            {email ? <button className='px-7 py-3 rounded-xl bg-black text-white
                            font-medium hover:bg-zinc-800 transition disabled:opacity-60'
                                onClick={() => navigate.push("/dashboard")}
                            >Go To Dashboard</button> : <button className='px-7 py-3 rounded-xl  
                            bg-black text-white font-medium hover:bg-zinc-800 transition 
                            disabled:opacity-60'
                                onClick={handleLogin}
                            >Get Started</button>}

                            <a href='#feature' className='px-7 py-3 rounded-xl border border-zinc-900
                    ...
                    <motion.div
                        ...
                        className="h-14 top:40 absolute right-50 w-96"
                    >
                        <div className='rounded-2xl bg-white shadow-2xl border border-zinc-200
                         p-6  '>
                            ...
                            <div className='space-y-3'>
                                ...
                                <div className='bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit'>
                                    yes,cash on delivery on available.
                                </div>
                            </div>
            ...
            <footer className='py-10 text-center text-sm text-zinc-500'>
                &copy;{new Date().getFullYear()} Support AI.All right's reserved.
            </footer>
