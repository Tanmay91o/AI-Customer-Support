        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            ...
            <div className='flex justify-center px-4 py-14'>
                ...
                >
                    ...
                    <p>Capy and Paste this code before <code>&lt;/body&gt;</code></p>
                    <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm
                    font-mono mb-10'>
                    ...
                    <div className='mt-14'>
                        ...
                        <div className='rounded-xl border border-zinc-300 bg-white shadow-md 
                        overflow-hidden'>

                            <div className='flex items-center gap-2 px-4 h-9 bg-zinc-100 border-b 
                            border-zinc-200'>
                            ...
                            shadow-xl border border-zinc-200 overflow-hidden'>
                                    ...
                                    <div className='bg-black text-white text-xs px-3 py-2 flex
